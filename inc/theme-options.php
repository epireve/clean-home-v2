...
function clean_home_admin_enqueue_scripts( $hook_suffix ) {
	wp_enqueue_style( 'clean-home-theme-options', get_template_directory_uri() . '/inc/theme-options.css', false, '20110801' );
}
...
function cleanhome_theme_options_do_page() {
	...
	?>
	<div class="wrap">
		<?php screen_icon(); echo "<h2>" . wp_get_theme() . ' ' . __( 'Theme Options', 'cleanhome' ) . "</h2>"; ?>
